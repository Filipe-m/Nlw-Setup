...
export function NewHabitForm (){
  return(
    <form action="" className="w-full flex flex-col mt-6">
      ...
      <input type="text" id="title" placeholder="Exercicios,dormir bem, beber água, etc..." autoFocus className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400"/>
